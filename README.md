...
```
$ git clone https://github.com/Bootcamp-AI/RoboND-DeepLearning.git
```
...
You'll need Python 3 and Jupyter Notebooks installed to do this project.  The best way to get setup with these if you are not already is to use Anaconda following along with the [RoboND-Python-Starterkit](https://github.com/Bootcamp-AI/RoboND-Python-StarterKit.git).
